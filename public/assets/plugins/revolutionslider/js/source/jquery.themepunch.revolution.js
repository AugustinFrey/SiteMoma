...
(function(jQuery, undefined) {
    ...
    jQuery.fn.extend({
        revolution: function(options) {
            ...
            var defaults = {
                delay: 9000,
                responsiveLevels: 1024, // Single or Array for Responsive Levels i.e.: 4064 or i.e. [2048, 1024, 768, 480]
            ...
            return this.each(function() {
                ...
                options.jsFileLocation =
                    options.jsFileLocation + options.extensions;
                ...
                jQuery(this).on("scriptsloaded", function() {
                    ...
                    // CHECK FOR MIGRATION
                    if (_R.migration != undefined)
                        options = _R.migration(c, options);
                    ...
                    if (opt && opt.li.length > 0) {
                        if (sindex > 0 || sindex <= opt.li.length) {
                            ...
                            if (opt.carousel && opt.carousel.slides)
                                opt.carousel.slides = removeArray(
                                    opt.carousel.slides,
                                    sindex
                                );
    ...
    jQuery.extend(true, _R, {
        ...
        callingNewSlide: function(container, direction) {
            ...
            if (
                container
                    .find(".active-revslide")
                    .hasClass("tp-invisible-slide")
            )
        ...
        setSize: function(opt) {
            ...
            opt.paddings =
                opt.paddings === undefined
                    ? {
                          top:
                              parseInt(opt.c.parent().css("paddingTop"), 0) ||
                              0,
                          bottom:
                              parseInt(
                                  opt.c.parent().css("paddingBottom"),
                                  0
                              ) || 0
                      }
                    : opt.paddings;
            ...
            if (opt.sliderLayout == "fullscreen" || opt.infullscreenmode) {
                ...
                if (opt.fullScreenOffsetContainer != undefined) {
                    try {
                        ...
                        if (offcontainers)
                            jQuery.each(offcontainers, function(
                                index,
                                searchedcont
                            ) {
                                coh =
                                    jQuery(searchedcont).length > 0
                                        ? coh -
                                          jQuery(searchedcont).outerHeight(true)
                                        : coh;
                            });
                    } catch (e) {}
                    try {
                        if (
                            ...
                            coh =
                                ...
                                (jQuery(window).height() *
                                    parseInt(opt.fullScreenOffset, 0)) /
                                    100;
                        else if (
                            opt.fullScreenOffset != undefined &&
                            opt.fullScreenOffset.length > 0
                ...
                opt.height =
                    parseInt(__mh, 0) > parseInt(opt.height, 0)
                        ? __mh
                        : opt.height;
            } else {
                if (opt.minHeight != undefined && opt.height < opt.minHeight)
        ...
        leaveViewPort: function(opt) {
            ...
            if (
                ...
                opt.lastplayedvideos = jQuery.extend(
                    true,
                    [],
                    opt.playingvideos
                );
    ...
    var checkIDS = function(opt, item) {
        ...
        if (ind != -1) {
            var newid =
                item.attr("id") + "_" + Math.round(Math.random() * 9999);
            item.attr("id", newid);
        }
    ...
    var waitForScripts = function(c, o) {
        ...
        if (
            ...
            (typeof punchgs !== "undefined" &&
                ...
                (!n.navigation ||
                    (n.navigation &&
                        typeof _R.createNavigation !== "undefined")) &&
                (!n.carousel ||
                    (n.carousel &&
                        typeof _R.prepareCarousel !== "undefined")) &&
                (!n.videos ||
                    (n.videos && typeof _R.resetVideo !== "undefined")) &&
                (!n.actions ||
                    (n.actions && typeof _R.checkActions !== "undefined")) &&
                (!n.layeranim ||
                    (n.layeranim &&
                        typeof _R.handleStaticLayers !== "undefined")) &&
                (!n.migration ||
                    (n.migration && typeof _R.migration !== "undefined")) &&
                (!n.parallax ||
                    (n.parallax &&
                        typeof _R.checkForParallax !== "undefined")) &&
                (n.carousel ||
                    (!n.carousel && typeof _R.animateSlide !== "undefined")))
        )
    ...
    var prepareOptions = function(container, opt) {
        opt.carousel.maxVisibleItems =
            opt.carousel.maxVisibleItems < 1
                ? 999
                : opt.carousel.maxVisibleItems; // === 1 ? 2 : opt.carousel.maxVisibleItems;
    ...
    var runSlider = function(container, opt) {
                ...
                apptxt =
                    linktoslide == "no"
                        ...
                        : apptxt +
                          ...
                          " >";
                apptxt =
                    apptxt + '<a style="width:100%;height:100%;display:block"';
                apptxt =
                    link != "slide"
                        ? apptxt +
                          ' target="' +
        ...
        opt.autoHeight =
            opt.sliderLayout == "fullscreen" ? "on" : opt.autoHeight;
        ...
        if (!container.hasClass("revslider-initialised")) {
            ...
            container
                ...
                .each(function(i) {
                    ...
                    _.isparallaxlayer =
                        _.startclasses.indexOf("rs-parallax") >= 0;

                    if (
                        _nc.hasClass("tp-static-layer") &&
                        _R.handleStaticLayers
                    ) {
                        _R.handleStaticLayers(_nc, opt);
                        if (opt.scrolleffect.on)
                            if (
                                (opt.scrolleffect.on_parallax_static_layers ===
                                    "on" &&
                                    _.isparallaxlayer) ||
                    ...
                    if (_nc.hasClass("tp-caption")) {
                        ...
                        if (nctype === "row") {
                            ...
                            specec =
                                _ndata.verticalalign === undefined
                                    ...
                                    : " vertical-align:" +
                                      _ndata.verticalalign +
                                      ";";
                            preclas = "rev_column";
                            _nc.addClass("rev_column_inner").removeClass(
                                "tp-resizeme"
                            );
                            _nc.data("width", "auto");
                        ...
                        if (addtofadeout && opt.scrolleffect.on)
                            if (
                                (opt.scrolleffect.on_parallax_layers === "on" &&
                                    _.isparallaxlayer) ||
                                (opt.scrolleffect.on_layers === "on" &&
                                    !_.isparallaxlayer)
                            )
                                opt.scrolleffect.layers.push(_nc.parent());
                        if (addToStaticFadeout)
                            opt.scrolleffect.layers.push(_nc.parent());
                        ...
                        if (nctype === "column") {
                            ...
                            _nc.closest(".tp-parallax-wrap").append(
                        ...
                        if (_nc.attr("id") === undefined)
                            _nc.attr(
                                "id",
                                "layer-" + Math.round(Math.random() * 999999999)
                            );
                        checkIDS(opt, _nc);
                    ...
                    if (
                        _ISM &&
                        (!opt.fallbacks.allowHTML5AutoPlayOnAndroid ||
                            !htmlvideo)
                    ) {
                        if (an == true || an == "true") {
                    ...
                    if (
                        ...
                        _nc.closest("li.tp-revslider-slidesli").addClass(
                            "rs-pause-timer-once"
                        );
            ...
            if (_R.resizeThumbsTabs && _R.resizeThumbsTabs)
                _R.resizeThumbsTabs(opt);
		...
		********************************/
            ...
            jQuery(window).on(resizid, function() {
                ...
                if (opt.sliderLayout == "fullscreen") {
                    ...
                    if (
                        (opt.fallbacks.ignoreHeightChanges == "mobile" &&
                            _ISM) ||
...
**************************************/
    ...
    var contWidthManager = function(opt) {
        ...
        if (
            ...
            var loff = Math.ceil(
                opt.c.closest(".forcefullwidth_wrapper_tp_banner").offset()
                    .left - rl
            );
            punchgs.TweenLite.set(opt.c.parent(), {
                ...
                width:
                    jQuery(window).width() -
                    _R.getHorizontalOffset(opt.c, "both")
            });
        } else {
            if (
                opt.sliderLayout == "fullscreen" &&
        ...
        if (!_R.resizeThumbsTabs || _R.resizeThumbsTabs(opt) === true) {
            ...
            if (nextsh.data("kenburns") == "on")
                _R.startKenBurn(
                    nextsh,
                    opt,
                    nextsh.data("kbtl") !== undefined
                        ? nextsh.data("kbtl").progress()
                        : 0
                );
            ...
            if (actsh.data("kenburns") == "on")
                _R.startKenBurn(
                    actsh,
                    opt,
                    actsh.data("kbtl") !== undefined
                        ? actsh.data("kbtl").progress()
                        : 0
                );
            ...
            if (
                _R.animateTheCaptions &&
                c.find(".processing-revslide").length > 0
            )
                _R.animateTheCaptions({
    ...
    var prepareSlides = function(container, opt) {
        container.find(".tp-caption").each(function() {
            var c = jQuery(this);
            if (c.data("transition") !== undefined)
                c.addClass(c.data("transition"));
        });
        ...
        opt.allli.find(">img").each(function(j) {
            ...
            mediafilter =
                mediafilter === "none" || mediafilter === undefined
                    ? ""
                    : mediafilter;
            img.wrap(
            ...
            if (bgcolor !== undefined && bgcolor.indexOf("gradient") >= 0)
                bgstyle =
                    '"background:' + bgcolor + ';width:100%;height:100%;"';
            else
                bgstyle =
                    '"background-color:' +
                    bgcolor +
        ...
        if (opt.loadqueue)
            jQuery.each(opt.loadqueue, function(index, queue) {
                var mqsrc = queue.src.replace(/\.\.\/\.\.\//gi, ""),
                    ...
                    fullsrc_b =
                        fullsrc.substring(0, fullsrc.length - 1) + "/" + mqsrc,
                ...
                if (
                    cutParams(origin) ===
                        cutParams(decodeURIComponent(img.src)) ||
                    cutParams(fullsrc) ===
                        cutParams(decodeURIComponent(img.src)) ||
                    cutParams(absolute) ===
                        cutParams(decodeURIComponent(img.src)) ||
            ...
            if (
                ...
                if (loadobj.type == "img") {
                    if (element.hasClass("defaultimg")) {
                        ...
                        nextli
                            .find(".slotholder")
                            .data("owidth", loadobj.width);
                        nextli
                            .find(".slotholder")
                            .data("oheight", loadobj.height);
                    } else {
                        ...
                        w =
                            w == undefined || w == "auto" || w == ""
                                ? loadobj.width
                                : w;
                        h =
                            h == undefined || h == "auto" || h == ""
                                ? loadobj.height
                                : h;
        ...
        if (opt.spinner === "off")
            if (opt.loader !== undefined) opt.loader.css({ display: "none" });
                ...
                opt.loadertimer = setTimeout(function() {
                    if (opt.loader !== undefined)
                        opt.loader.css({ display: "block" });
                }, 50);
    ...
    var letItFree = function(container, nextsh, actsh, nextli, actli, mtl) {
        ...
        nextli.find(".rs-background-video-layer").each(function(i) {
            if (_ISM && !opt.fallbacks.allowHTML5AutoPlayOnAndroid)
                return false;
            var _nc = jQuery(this);
        ...
        if (opt.rowzones != undefined)
            _actli =
                _actli > opt.rowzones.length ? opt.rowzones.length : _actli;
        ...
        jQuery(".rev_redraw_on_blurfocus").each(function() {
            ...
            if (opt.windowfocused != true) {
                ...
                punchgs.TweenLite.delayedCall(0.3, function() {
                    ...
                    if (opt.fallbacks.nextSlideOnWindowFocus == "on")
                        opt.c.revnext();
                    opt.c.revredraw();
